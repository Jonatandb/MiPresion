...
const SocialMedia = () => {
  const handleClick = (target: string, action = "LinkClicked") => trackEvent("Interaction", action, "SocialMedia -> " + target)
      ...
      <div className={styles.socialMediaContainer}>
        <div className={styles.pictureContainer}>
          <a href="http://jonatandb.github.io/"
            ...
            onClick={() => handleClick("ProfilePicture", "ImageClicked")}
          >
            <img
              src={jonatandb}
        ...
        <div className={styles.linksContainer}>
          <a href="mailto:jonatandb@gmail.com" onClick={() => handleClick("Gmail")}>
            <img src={gmail} width="1rem" height="1rem" alt="Logo de Gmail" title='Correo a Jonatandb' />
            Gmail
          </a>
          <a href="http://github.com/jonatandb" target="_blank" rel="noopener noreferrer" onClick={() => handleClick("Github")}>
            <img src={github} width="1rem" height="1rem" alt="Logo de Github" title='Ir al Github de Jonatandb' />
            Github
          </a>
          <a href="http://linkedin.com/in/jonatandb" target="_blank" rel="noopener noreferrer" onClick={() => handleClick("LinkedIn")}>
            <img src={linkedin} width="1rem" height="1rem" alt="Logo de LinkedIn" title='Ir al LinkedIn de Jonatandb' />
            LinkedIn
          </a>
          <a href="https://twitter.com/jonatandb" target="_blank" rel="noopener noreferrer" onClick={() => handleClick("Twitter")}>
